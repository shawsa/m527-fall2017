...
\problem{15 from the book}
	...
	$$
	\frac{F(x)}{-c^2 F^{(4)}(x)} = \frac{G(t)}{G^{\prime\prime}(t)} = k
	$$
	for some constant $k$. This is because each side of the equation is equal for every value of $x$ and every value of $t$. 
